...
def bind():
    ...
    def render(econtext, rcontext=None):
        ...
        'grid_1'
        dom_id = 'grid_1'
        "','.join([f.metadata.get('label') for f in collection.render_fields.values()])"
        ...
        "','.join([f.metadata.get('json') for f in collection.render_fields.values()])"
